...
/*
 * DataInputStream 을 이용해서 Data 를 읽을때 주의할 점 !!!
 * 
 * 1. 반드시 쓰인 순서 그대로 읽어야 함.. 즉 int,double,float 으로 썼으면, 읽을때도 같은 순서대로 읽는다.
 * 
 * 2. read......(); 을 루프등을 이용해서 사용할 때, 데이터의 끝은 -1이 아니라 EOFException 을 발생시켜 끝을 나타낸다..
