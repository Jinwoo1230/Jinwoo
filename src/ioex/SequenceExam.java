...
public class SequenceExam {
	...
	public static void main(String[] args) {
		...
		//하나 이상의 입력 스트림을 하나로 처리하는 Seq.. 스트림 선언.
		...
		try {
			...
			//SequenceInputStream의 생성자에 Enumeration 객체로 스트림들을 넘겨주기 위해
			//Vector의 Enumeration 을 리턴하는 메서드를 호출합니다.
			Enumeration<InputStream> er = streams.elements();
			
			//SequenceInputStream 객체를 생성하면서, 입력 대상인 er 객체를 파라미터로 줍니다.
