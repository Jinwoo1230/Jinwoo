...
/*
 * 이 클래스는 DB에 접근해서 데이터를 select(조회), insert(삽입), updata(갱신), delete(삭제)를 하는 기능의 DAO 입니다.
 * 기본적으로 Singleton 방식으로 정의할 예정입니다.
 * 따라서 생성자는 private으로 정의하고, static 메서드를 이용해서 외부 객체가 instance를 사용할 수 있도록 정의합니다. 꼭 기억하기!
 */
public class StudentDAO {
	...
	//넘겨받은 DTO를 DB에 Insert 한다라고 가정하고 출력하도록 하는 메서드 정의합니다.
