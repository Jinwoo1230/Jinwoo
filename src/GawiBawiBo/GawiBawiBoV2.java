...
public class GawiBawiBoV2 {
	...
	public static void main(String[] args) {
		 ...
		 * 3.1 GawiBawiboV2 클래스는 play() 에서 객체를 만들어 호출 되어야 합니다.
		 * 3.2 play() 에서 호출된 객체는 사용자로부터 email 을 입력 받아서 필드로 저장을 해야합니다.
		 * 3.3 필요에 따라서 사용자의 ID가 뭔지를 리턴 받을 수 있는 getter() 를 구현하세요
		 * 3.4 이 클래스 <-- 여기까지가 클래스1
		 * 3.5 여기서부터 클래스2 --> 내부에는 사용자 이름을 입력받고 난 후, 실제 게임을 진행하는 클래스의 객체를 생성합니다.
		 * 이때 객체 생성 후 특정 메서드를 호출 하지 않아도 내부적으로 호출하여 사용자에게 게임 하겠는지 물어봅니다.
		 ...
		 * 어떤 클래스는 객체 초기화가 필요할 수 있고, 메서드에서는 피라미터가 전달 되어야 할 수 있으면, 어떤 메서드는 리턴을 해야 합니다.
		 * 
