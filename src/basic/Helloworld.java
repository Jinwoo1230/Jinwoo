...
public class Helloworld {
	//자바 Application(모바일이나, 탭이 아닌 일반pc에서 실행되는 App)
	//은 몇천개의 클래스가 구성되어 하나의 프로그램으로 완성되어집니다.
	//위에서 완성된 App 이 실행이 될 때 JVM은 반드시 찾게되는 메서드가 있습니다.
	//즉 프로그램이 main 메서드라고 합니다.
	//main 메서드는 이렇게 중요한 의미를 가지고 있기 때문에 이 메서드를 보유한 클래스가
	//일반적으로 main 클래스가 됩니다.
	//이 메서드는 하나의 클래스만 가질 수 있습니다. 즉 시작점이 하나란 말입니다.
