...
class Account{
	...
	public synchronized void withdraw(int money) {//인출 메서드
		if(this.balance >= money) {
			try {
				Thread.sleep(1000);//너무 빠르지 않게 약간의 딜레마를 준다.
				this.balance -= money;
...
class ConThread implements Runnable{
	//이 쓰래드가 위의 Account 객체 하나를 공유 하도록 하기위해
